...
/ip dns static remove [find where name="cvlmedia.my.id" and address="192.168.200.1"]

# Tambahkan DNS static untuk domain aplikasi
/ip dns static add name="cvlmedia.my.id" address="192.168.200.1" ttl=300
...
/ip proxy access add dst-host=!cvlmedia.my.id action=deny comment="Block all except isolir page"

/ip proxy access add dst-host=cvlmedia.my.id action=allow comment="Allow isolir page"
...
:put "Halaman isolir: https://cvlmedia.my.id/isolir"
