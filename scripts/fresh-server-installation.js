...
async function freshServerInstallation() {
    ...
    try {
        ...
        const appSettings = [
            { key: 'company_name', value: 'CV Lintas Multimedia' },
            { key: 'company_phone', value: '0813-6888-8498' },
            { key: 'company_email', value: 'info@alijaya.com' },
            { key: 'company_address', value: 'Jl. Contoh Alamat No. 123' },
            { key: 'company_header', value: '📱 CV Lintas Multimedia 📱\n\n' },
            { key: 'footer_info', value: 'Powered by Alijaya Digital Network' },
            { key: 'contact_phone', value: '0813-6888-8498' },
