...
echo "  - Admin Portal: http://$(curl -s ifconfig.me || echo 'SERVER_IP'):22916/admin/login"
echo "  - Customer Portal: http://$(curl -s ifconfig.me || echo 'SERVER_IP'):22916"
echo ""
...
echo ""
echo "🎯 Gembok-Bill is now running on port 22916!"
echo "   Check: $(curl -s ifconfig.me || echo 'SERVER_IP'):22916"
